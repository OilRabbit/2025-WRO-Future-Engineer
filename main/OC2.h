...
typedef enum {
  ...
  ENDING_STATE_OC2,
  ANTI_OUT_PARKING_P1_STATE,
  ANTI_OUT_PARKING_P2_STATE,
  ANTI_OUT_PARKING_P3_STATE,
  ANTI_OUT_PARKING_P4_STATE,
  ANTI_OUT_PARKING_P5_STATE,
  ANTI_OUT_PARKING_P6_STATE,
  ANTI_OUT_PARKING_RED_P1_STATE,
  CLK_OUT_PARKING_P1_STATE,
  CLK_OUT_PARKING_RED_P1_STATE,
  CLK_OUT_PARKING_RED_P2_STATE,
  CLK_OUT_PARKING_GREEN_P1_STATE,
  CLK_OUT_PARKING_UNK_P1_STATE,
  CLK_OUT_PARKING_UNK_P2_STATE,
  CLK_OUT_PARKING_UNK_P3_STATE,
  CLK_OUT_PARKING_P2_STATE,
  // OUT_PARKING_P1_STATE,
  // OUT_PARKING_P2_STATE,
  // OUT_PARKING_P2_5_STATE,
