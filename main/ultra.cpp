...
//   while(1){
//     ultra2Dist = getUltra2Dist(300);
//     // ultra2Dist = getUltra2DistMedian(10, 300);
//     vTaskDelay(5 / portTICK_PERIOD_MS);
//   }
// }
...
//  * @param clearDisplay; bool; Set true to clear the whole OLED display everytime before displaying the battery percentage
//   */
// void showUltra2Dist(COLUMN column, int line_number, int text_size, uint16_t text_colour = TFT_WHITE, bool clearDisplay){
