...
extern NewPing ultra3;

extern int ultra1Dist;
extern int ultra2Dist;
extern int ultra3Dist;
...
int getUltra3Dist(int max_dist_cm);
int getUltra3DistMedian(int iter, int max_dist_cm);
void getultra3Distloop(void *parameters);
void showUltra3Dist(TFT_COLUMN column, int line_number, int text_size, uint16_t text_colour, bool clearDisplay);
